...
def main():
    ...
    parser.add_argument("--start-date", type=str, default=None,
                        help="Override start date (dd-mm-yyyy), e.g. 02-01-2009")
    parser.add_argument("--end-date", type=str, default=None,
                        help="Override end date (dd-mm-yyyy), e.g. 03-04-2016")
    ...
    if args.start_date:
        start_date = pd.to_datetime(args.start_date, format="%d-%m-%Y")
    else:
